...
| [04-avatar-on-real-metro-hub.png](evidence/epic10/04-avatar-on-real-metro-hub.png) | Nhân vật đồng hành đã chọn xuất hiện và di chuyển trực tiếp trên tàu Metro ba toa thật, không bị che navigation rail, tab hay các nút bấm CTA chính. | Desktop (1280x800) |
| [05-real-metro-before-switch.png](evidence/epic10/05-real-metro-before-switch.png) | Trạng thái tàu Metro ba toa thực tế tại ga hiện tại trước khi thực hiện chuyển đổi nhanh. | Desktop (1280x800) |
| [06-real-metro-mid-transition-no-overlap.png](evidence/epic10/06-real-metro-mid-transition-no-overlap.png) | Trạng thái tàu Metro ba toa đang di chuyển ở giữa hành trình chuyển đổi ga (mid-frame), chứng minh không đè lên hay giao cắt với bất kỳ station icons hay labels nào. | Desktop (1280x800) |
| [07a-live-hub-three-car-single-click-glide.webm](evidence/epic10/07a-live-hub-three-car-single-click-glide.webm) | Video ghi lại hành trình tàu Metro ba toa lướt mượt mà giữa các ga khi click đơn, chứng minh chuyển động liên tục không có giật snap/teleport ở điểm cuối. | Desktop (1366x768) |
| [07b-live-hub-three-car-frame-sequence.png](evidence/epic10/07b-live-hub-three-car-frame-sequence.png) | Chuỗi 11 phân cảnh chuyển động từ lúc khởi hành (0%) đến kết thúc (100%) của tàu Metro ba toa đi qua ga kề cận. | Desktop (Canvas) |
| [07c-live-hub-rail-motion-and-sound-state.webm](evidence/epic10/07c-live-hub-rail-motion-and-sound-state.webm) | Video ghi lại hành trình tàu dài chạy dọc theo làn ray và phản ứng tức thời với âm thanh khi thay đổi trạng thái bật/tắt trong lúc chạy. | Desktop (1366x768) |
| [07d-live-hub-three-car-rapid-retarget.webm](evidence/epic10/07d-live-hub-three-car-rapid-retarget.webm) | Video ghi lại tính năng retarget nhanh: đảo chiều di chuyển tức thì từ vị trí đang chạy khi người dùng click liên tiếp ga mới mà không bị reset/giật về điểm đầu. | Desktop (1366x768) |
| [07e-live-hub-sound-toggle.webm](evidence/epic10/07e-live-hub-sound-toggle.webm) | Video ghi lại nút bật/tắt âm thanh, kiểm tra tính năng lưu trạng thái vào localStorage và di chuyển tĩnh lặng khi tắt tiếng. | Desktop (1366x768) |
| [08-real-metro-mobile-no-overlap.png](evidence/epic10/08-real-metro-mobile-no-overlap.png) | Giao diện di động (viewport 390) hiển thị tàu Metro ba toa di chuyển dọc theo làn đường ray bên phải, hoàn toàn tách biệt hình học và không đè lên các nút bấm/tiêu đề ga ở bên trái. | Mobile (390x800) |
