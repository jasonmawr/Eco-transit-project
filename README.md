...
- [Danh Sách Kiểm Tra Trình Diễn (docs/FINAL_DEMO_CHECKLIST.md)](docs/FINAL_DEMO_CHECKLIST.md)
- [Hướng Dẫn Triển Khai Chi Tiết (docs/DEPLOY_DEMO.md)](docs/DEPLOY_DEMO.md)
- [Kịch Bản Trình Diễn Báo Cáo (docs/DEMO_RUNBOOK.md)](docs/DEMO_RUNBOOK.md)
- [Danh Sách Hạn Chế Đã Biết (docs/KNOWN_LIMITATIONS.md)](docs/KNOWN_LIMITATIONS.md)

---

## 4. Các Hạn Chế Bản Demo (Known Limitations)
Xem chi tiết danh sách giới hạn vận hành đóng băng tại [KNOWN_LIMITATIONS.md](docs/KNOWN_LIMITATIONS.md). Mọi tệp ảnh chụp vé tải lên thư mục `uploads/tickets` sẽ bị xóa sạch khi máy chủ Render Web Service gói miễn phí khởi động lại hoặc redeploy. Dữ liệu chỉ mang tính chất demo mô phỏng truyền thông.
